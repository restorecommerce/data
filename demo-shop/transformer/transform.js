...
function writeMutation(list_meta) {
    ...
    fs.createWriteStream("output/" + filename + ".json")
        .write(jsonOutput);
}
    ...
    .on('end', () => {    
        ...
        if (numProducts > 1000) { // split up mutation if very large
            ...
            for (let i = 0; i < numSlices; i++) {
                ...
                if (i < 10) {
                    filename = "createProducts00" + String(i);
                } else if (i < 100) {
                    filename = "createProducts0" + String(i);
                } else {
                    filename = "createProducts" + String(i);
                }
